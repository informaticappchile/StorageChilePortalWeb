<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Pagos.aspx.cs" Inherits="Presentacion.Pagos" %>
                                ...
                                <ul class="demo-list-control mdl-list">
                                    ...
                                    <li class="mdl-list__item">
                                        <span class="mdl-list__item-primary-content">
                                            ...
                                            <span class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                                    <asp:DropDownList id="tipo_pago_register" runat="server" AutoPostBack="true" CssClass="mdl-textfield__input" OnDataBinding="tipoPagoChangeIndex" OnTextChanged="tipoPagoChangeIndex">
                                                    </asp:DropDownList>
