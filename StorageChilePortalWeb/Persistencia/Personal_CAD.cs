    ...
    public class Personal_CAD
    {
        ...
        public void InsertarPersonal(Personal_EN p)
        {
            ...
            try
            {
                ...
                string insert = "insert into Personal(NombrePersonal,RutPersonal) VALUES ('" + p.Nombre + "','" + p.Rut + "')";
         ...
         */
        public Personal_EN BuscarPersonal(string busqueda)
        {
            Personal_EN pers = null;
            Conexion nueva_conexion = new Conexion();
            try
            {
                string select = "Select * from Personal where RutPersonal ='" + busqueda + "'";
                ...
                {
                    pers = new Personal_EN();
                    pers.ID = Convert.ToInt16(dt.Rows[0]["IdPersonal"]);
                    pers.Rut= dt.Rows[0]["RutPersonal"].ToString();
                    pers.Nombre = dt.Rows[0]["NombrePersonal"].ToString();
