   ...
   <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable = no"/>
    ...
    <div class="demo-card-wide mdl-card mdl-shadow--2dp">
        <div class="mdl-card__title">
            <h1 class="mdl-card__title-text">Administración de Movimientos</h1>
        </div>
        <br />
        <div>
        ...
        <br />
         <div class="mdl-card__actions mdl-card--border">
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Almacen/Movimientos.aspx" CssClass="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">Volver a Registrar</asp:HyperLink>
